...
@section('content')
    ...
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Sedes <small>Mantenimiento</small></h1>
    <!-- END page-header -->
    <!-- BEGIN row -->
    <div class="row">
        <!-- BEGIN col-12 -->
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Listado de Sedes</h4>
