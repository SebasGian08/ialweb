    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('auth.' . strtolower($ViewName) . '.store') }}" id="frm{{ $ViewName }}"
                ...
                <input type="hidden" id="portada_path" name="portada_path"
                    value="{{ $Model != null ? $Model->portada_path : '' }}">
                <input type="hidden" id="imagen_habilidad_path" name="imagen_habilidad_path"
                    value="{{ $Model != null ? $Model->imagen_habilidad_path : '' }}">
                <input type="hidden" id="brochure_path" name="brochure_path"
                    value="{{ $Model != null ? $Model->brochure_path : '' }}">
                <div class="modal-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a href="#default-tab-5" data-bs-toggle="tab" class="nav-link">
                                <span class="d-sm-none">Certificaciones Modulares</span>
                                <span class="d-sm-block d-none">Certificaciones Modulares</span>
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content panel rounded-0 p-3 m-0">
                        <div class="tab-pane fade active show" id="default-tab-1">
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6 imagen-content portada">
                                    ...
                                    <div class="file-loading">
                                        <input id="portada" name="portada"
                                            data-preview="{{ $Model != null ? $Model->portada : '' }}"
                                            accept="image/png, image/gif, image/jpeg, image/jpg" type="file">
                                    </div>
                            ...
                            <div class="form-group row mb-3">
                                <div class="col-md-6">
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="fecha_inicio" class="form-label col-form-label">Fecha
                                                Inicio:</label>
                                            <input type="date" id="fecha_inicio" name="fecha_inicio"
                                                class="form-control"
                                                value="{{ $Model != null ? $Model->fecha_inicio : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="duracion" name="duracion"
                                                class="form-control"
                                                value="{{ $Model != null ? $Model->duracion : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="turno[]" id="turno" class="form-control"
                                                ...
                                                <option value="Mañana"
                                                    {{ $Model != null && $Model->turno != null && in_array('Mañana', $Model->turno) ? 'selected' : '' }}>
                                                    Mañana</option>
                                                <option value="Tarde"
                                                    {{ $Model != null && $Model->turno != null && in_array('Tarde', $Model->turno) ? 'selected' : '' }}>
                                                    Tarde</option>
                                                <option value="Noche"
                                                    {{ $Model != null && $Model->turno != null && in_array('Noche', $Model->turno) ? 'selected' : '' }}>
                                                    Noche</option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            <label for="modalidad"
                                                class="form-label col-form-label">Modalidades:</label>
                                            <select name="modalidad[]" id="modalidad" class="form-control"
                                                style="width: 100% !important;" multiple="multiple">
                                                <option value="">Ninguno</option>
                                                <option value="Presencial"
                                                    {{ $Model != null && $Model->modalidad != null && in_array('Presencial', $Model->modalidad) ? 'selected' : '' }}>
                                                    Presencial</option>
                                                <option value="Virtual"
                                                    {{ $Model != null && $Model->modalidad != null && in_array('Virtual', $Model->modalidad) ? 'selected' : '' }}>
                                                    Virtual</option>
                                            </select>
                        ...
                        <div class="tab-pane fade" id="default-tab-2">
                            <div class="form-group row">
                                <div class="col-md-6 imagen-content habilidad">
                                    ...
                                    <div class="file-loading">
                                        <input id="imagen_habilidad" name="imagen_habilidad"
                                            data-preview="{{ $Model != null ? $Model->imagen_habilidad : '' }}"
                                            accept="image/png, image/gif, image/jpeg, image/jpg" type="file">
                                    </div>
                                ...
                                <div class="col-md-6 imagen-content brochure">
                                    ...
                                    <div class="file-loading">
                                        <input id="brochure" name="brochure"
                                            data-preview="{{ $Model != null ? $Model->brochure : '' }}"
                                            accept="application/pdf" type="file">
                                    </div>
                                    <div id="kartik-file-errors3"></div>
                                </div>
                                <div class="col-md-12">
                                    <label for="video_beneficios" class="form-label col-form-label">Video Youtube
                                        URL:</label>
                                    <input type="text" id="video_beneficios" name="video_beneficios"
                                        class="form-control"
                                        value="{{ $Model != null ? $Model->video_beneficios : '' }}">
                        ...
                        <div class="tab-pane fade" id="default-tab-3">
                            <div class="form-group row">
                                <div id="oportunidades" class="col-md-12">
                                    <label for="oportunidades_profesionales"
                                        class="form-label col-form-label">Oportunidades Profesionales:</label>
                                        ...
                                        @for ($i = 0; $i < count($Model->oportunidades_profesionales); $i++)
                                            <div class="input-group">
                                                <input type="text"
                                                    ...
                                                    value="{{ $Model->oportunidades_profesionales[$i] }}">
                                                @if ($i == 0)
                        ...
                        <div class="tab-pane fade" id="default-tab-4">
                            <div class="form-group row">
                                <div id="egresados" class="col-md-12">
                                    <label for="perfil_egresado" class="form-label col-form-label">Perfil
                                        Egresado:</label>
                        ...
                        <div class="tab-pane fade" id="default-tab-5">
                            <div class="form-group row">
                                <div id="certi" class="col-md-12">
                                    <label for="certi" class="form-label col-form-label">Certificaciones
                                        Modulares:</label>
                                    @if ($Model != null && $Model->certificaciones != null && count($Model->certificaciones) > 0)
                                        @for ($i = 0; $i < count($Model->certificaciones); $i++)
                                            <div class="input-group">
                                                <input type="text"
                                                    class="form-control r-description n1s pull-right"
                                                    name="certificaciones[]"
                                                    value="{{ $Model->certificaciones[$i] }}">
                                                @if ($i == 0)
                                                    <div class="btn btn-primary input-group-addon add_input_button"
                                                        style="border-radius: 0"><i class="fa fa-plus fa-sm"></i>
                                                    </div>
                                    ...
                                    @endif
                                    <div class="field_wrapper"></div>
                                    <span data-valmsg-for="certificaciones"></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $image_habilidad.fileinput({
            ...
            allowedFileExtensions: ["jpeg", "jpg", "png", "gif"],
            initialPreview: $image_habilidad.attr('data-preview') !== "" ? [$image_habilidad.attr(
                'data-preview')] : [],
            initialPreviewConfig: [{
                caption: "Imagen"
            }]
        ...
        $brochure.fileinput({
            ...
            elErrorContainer: '#kartik-file-errors3',
        ...
        /* certificaciones */
        const $certi = $("#certi");
        $certi.on("click", ".add_input_button", function() {
            const $fieldWrapper = $certi.find('.field_wrapper')
            const $htmlHeadGroupInput = '<div class="input-group">';
            const $htmlEndGroupInput =
                '<div class="btn btn-danger input-group-addon remove_input_button" style="border-radius: 0"><i class="fa fa-times"></i></div></div>';
            $fieldWrapper.append($htmlHeadGroupInput +
        ...
        $certi.on("click", ".remove_input_button", function() {
            const $this = $(this);
            $this.closest(".input-group").remove();
        });
