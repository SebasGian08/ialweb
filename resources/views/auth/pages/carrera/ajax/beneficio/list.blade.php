...
<script type="text/javascript">
    $(function (){
        ...
        const $DataTable = $table.DataTable({
            ...
            "ajax": {
                url: `/auth/${$route}/partial-view-list-json-gift?id={{ $Id }}`,
            },
            "columns": [
        ...
        $table.on("click", ".btn-delete", function () {
            ...
            confirmAjax(`/auth/${$route}/delete-gift`, formData, "POST", `¿Está seguro de eliminar el item?`, null, function () {
                $DataTable.ajax.reload(null, false);
            });
        });

        function partialView(id){
            getModal(`/auth/${$route}/partial-view-gift/${id ? id : 0}/{{ $Id }}`, function ($modal) {
