...
<script type="text/javascript">
    $(function (){
        ...
        const $DataTable = $table.DataTable({
            ...
            "ajax": {
                url: `/auth/${$route}/partial-view-list-json-ability?id={{ $Id }}`,
            },
            "columns": [
        ...
        $table.on("click", ".btn-delete", function () {
            ...
            confirmAjax(`/auth/${$route}/delete-ability`, formData, "POST", `¿Está seguro de eliminar el item?`, null, function () {
                $DataTable.ajax.reload(null, false);
            });
        });

        function partialView(id){
            getModal(`/auth/${$route}/partial-view-ability/${id ? id : 0}/{{ $Id }}`, function ($modal) {
