...
@section('content')
    ...
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Novedades <small>Mantenimiento</small></h1>
    <!-- END page-header -->
    <!-- BEGIN row -->
    <div class="row">
        <!-- BEGIN col-12 -->
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Listado de Novedades</h4>
    ...
    <script type="text/javascript">
        $(function (){
            ...
            const $DataTable = $table.DataTable({
                ...
                "columns": [
                    { title: "Categoría", data: "categoria", className: "text-left" },
