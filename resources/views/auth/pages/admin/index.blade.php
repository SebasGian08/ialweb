...
@section('content')
    ...
    <ol class="breadcrumb float-xl-end">
        <li class="breadcrumb-item"><a href="{{ route('auth.dashboard.index') }}">Dashboard</a></li>
        <li class="breadcrumb-item active">Administradores</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Administradores <small>Mantenimiento</small></h1>
    <!-- END page-header -->
    <!-- BEGIN row -->
    <div class="row">
        <!-- BEGIN col-12 -->
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Listado de Administradores</h4>
                    <div class="panel-heading-btn">
                        <a href="javascript:;" class="btn btn-xs btn-icon btn-default" data-toggle="panel-expand"><i
                                class="fa fa-expand"></i></a>
                        <a href="javascript:;" class="btn btn-xs btn-icon btn-warning" data-toggle="panel-collapse"><i
                                class="fa fa-minus"></i></a>
                        <a href="javascript:;" class="btn btn-xs btn-icon btn-refresh btn-success"><i
                                class="fa fa-redo"></i></a>
                        <a href="javascript:;" class="btn btn-xs btn-icon btn-add btn-primary"><i
    ...
    <script type="text/javascript">
        $(function () {
            ...
            const $DataTable = $table.DataTable({
                ...
                "columns": [
                    { title: "Nombres", data: "nombres", className: "text-left" },
                    { title: "Email", data: "email", className: "text-left" },
