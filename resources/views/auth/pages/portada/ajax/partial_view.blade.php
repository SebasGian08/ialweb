    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('auth.'.strtolower($ViewName).'.store') }}" id="frm{{$ViewName}}" enctype="multipart/form-data" method="POST"
                ...
                <input type="hidden" id="imagen_mobile_path" name="imagen_mobile_path" value="{{ $Model != null ? $Model->imagen_mobile_path : "" }}">
                <div class="modal-body">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-6 imagen-content mobile">
                            <label for="imagen_mobile" class="form-label col-form-label">Imagen Mobile: <span class="text-danger">(*)</span></label>
                            <div class="file-loading">
                                <input id="imagen_mobile" name="imagen_mobile"  data-preview="{{ $Model != null ? $Model->imagen_mobile : ""}}" accept="image/png, image/gif, image/jpeg, image/jpg"  type="file">
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-12">
                                    <label for="link" class="form-label col-form-label">Link:</label>
                                    <textarea id="link" name="link" rows="4" class="form-control">{{ $Model != null ? $Model->link : ""  }}</textarea>
...
<script type="text/javascript">
    $(function () {
        ...
        const $image_mobile = $("#imagen_mobile");
        $image_mobile.fileinput({
            showPreview: true,
            showUpload: false,
            language: "es",
            initialPreviewAsData: true,
            initialPreviewFileType: 'image',
            elErrorContainer: '#kartik-file-errors', allowedFileExtensions: ["jpeg", "jpg", "png", "gif"],
            initialPreview:  $image_mobile.attr('data-preview') !== "" ? [$image_mobile.attr('data-preview')] : [],
            initialPreviewConfig: [{caption: "Imagen"}]
        });
        $("body").on("click", "button.fileinput-remove", function (){
            ...
            if($imageContent.hasClass("imagen")){
                $("#imagen_path").val("");
            }else if($imageContent.hasClass("mobile")){
                $("#imagen_mobile_path").val("");
            }
        });
