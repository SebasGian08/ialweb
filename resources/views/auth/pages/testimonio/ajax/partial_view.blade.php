                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-12">
                                    <label for="cargo" class="form-label col-form-label">Cargo: <span class="text-danger">(*)</span></label>
                                    <input type="text" id="cargo" name="cargo" class="form-control" value="{{ $Model != null ? $Model->cargo : ""  }}" required>
                                    <span data-valmsg-for="cargo"></span>
                                </div>
                                <div class="col-md-12">
                                    <label for="descripcion" class="form-label col-form-label">Descripción: <span class="text-danger">(*)</span></label>
                                    <textarea id="descripcion" name="descripcion" rows="6" class="form-control">{{ $Model != null ? $Model->descripcion : ""  }}</textarea>
                                    <span data-valmsg-for="descripcion"></span>
                                </div>
                                <div class="col-md-12">
                                    <label for="referencia" class="form-label col-form-label">Referencia: <span class="text-danger">(*)</span></label>
                                    <input type="text" id="referencia" name="referencia" class="form-control" value="{{ $Model != null ? $Model->referencia : ""  }}" required>
